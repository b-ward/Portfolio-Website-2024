...
const TrioHome = () => {
    ...
    return (
        <div className="trio-wrapper">
            ...
            <img id="play" src='../Trio/Images/background.png' alt="background" style={{position:'absolute', width:'100%', height:'700px', overflowX:'auto'}}/>
            <div className="playContainer" onClick={() => window.location.href='TrioGame'}>
              <img id="playGame" src='../Trio/Images/card_back.png' alt="card" style={{position:'absolute', width:'126px', height:'182px', left:'300px', top:'200px'}}/>
              <p id='p1'>PLAY</p>
            </div>
            <div className="instructionContainer" onClick={() => window.location.href='TrioInstructions'}>
              <p id='p2'>HOW TO PLAY</p>
              <img id="instructions" src='../Trio/Images/card_back.png' alt="card" style={{position:'absolute', width:'126px', height:'182px', left:'650px', top:'200px'}}/>
            </div>
            ...
            {helpModalShow && (
                <Modal title="Help" onClose={() => setHelpModalShow(false)}>
                    ...
                    <p>
                        For more examples see: <a href="https://www.betfair.com.au/hub/arbitrage-betting/">https://www.betfair.com.au/hub/arbitrage-betting/</a><br/>
